...
.. list-table::
   ...
   * - **Binning method**
     - Fixed-width bins
     - Optimal variable-width bins
   * - **Bins parameter**
     - ``bins`` (int or edges)
     - ``max_bins`` (optional limit)
   * - **Default bins**
     - 10 fixed bins
     - Auto-determined optimal
   * - **Weights support**
     - Yes
     - No
   * - **Returns**
...
.. list-table::
   ...
   * - Use NumPy
     - Use Khisto
   * - Need fixed-width bins
     - Want optimal data representation
   * - Need weighted histograms
     - Want automatic bin selection
   * - Need specific bin edges
     - Want adaptive bin widths
...
.. list-table::
   ...
   * - **Binning**
     - Fixed-width
     - Optimal variable-width
   * - **Bins param**
     - ``bins``
     - ``max_bins``
   * - **Axes param**
     - Implicit (current)
     - Optional ``ax`` parameter
   * - **Cumulative**
     - Supported
     - Supported
   * - **Stacked**
